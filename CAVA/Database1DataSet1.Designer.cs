...
namespace CAVA {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(System.Guid Id, string Name, string Lastname, string Password) {
...
namespace CAVA.Database1DataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Lastname = 1 AND [Lastname] IS NULL) OR ([Lastname] = @Original_Lastname)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [Name], [Lastname], [Password]) VALUES (@Id, @Na" +
                "me, @Lastname, @Password);\r\nSELECT Id, Name, Lastname, Password FROM [Table] WHE" +
                "RE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [Name] = @Name, [Lastname] = @Lastname, [Password] = @Password WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Lastname = 1 AND [Lastname] IS NULL) OR ([Lastname] = @Original_Lastname)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)));
SELECT Id, Name, Lastname, Password FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CAVA.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Lastname, Password FROM dbo.[Table]";
        ...
        public virtual int Delete(System.Guid Original_Id, string Original_Name, string Original_Lastname, string Original_Password) {
        ...
        public virtual int Insert(System.Guid Id, string Name, string Lastname, string Password) {
        ...
        public virtual int Update(System.Guid Id, string Name, string Lastname, string Password, System.Guid Original_Id, string Original_Name, string Original_Lastname, string Original_Password) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Lastname, string Password, System.Guid Original_Id, string Original_Name, string Original_Lastname, string Original_Password) {
            return this.Update(Original_Id, Name, Lastname, Password, Original_Id, Original_Name, Original_Lastname, Original_Password);
        }
    }
